...
describe('Benchmark Serialization Performance', () => {
    ...
    test('Benchmark: JSON.stringify with Array.from vs Buffer Extraction', () => {
        ...
        console.log(`Current JSON Length: ${(jsonCurrent.length / 1024 / 1024).toFixed(2)} MB`);
        ...
        console.log(`Optimized JSON Length: ${(jsonOptimized.length / 1024 / 1024).toFixed(2)} MB`);
