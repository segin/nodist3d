...
function runBenchmark() {
    ...
    console.log(`Closure Pattern: ${durationClosure.toFixed(2)}ms, Heap Delta: ${((endMemClosure - startMemClosure)/1024).toFixed(2)} KB`);
    ...
    console.log(`Bound Pattern:   ${durationBound.toFixed(2)}ms, Heap Delta: ${((endMemBound - startMemBound)/1024).toFixed(2)} KB`);
